...
- Strict starter scope for the Octet burndown: `valence_math`, `valence_lang`, `valence_ident`, `valence_text`, `valence_weather`, `valence_world_border`, `valence_boss_bar`, `valence_player_list`, `valence_scoreboard`, `valence_equipment`, `valence_advancement`, `valence_anvil`, `valence_inventory`, `valence_registry`.
...
- Octet strict starter burndown cleaned `valence_math`, `valence_lang`, `valence_ident`, `valence_text`, `valence_weather`, `valence_world_border`, `valence_boss_bar`, `valence_player_list`, `valence_scoreboard`, `valence_equipment`, `valence_advancement`, `valence_anvil`, `valence_inventory`, and `valence_registry`; next broadening candidates should stay below `valence_server_common` until the Dylint driver/source-map caveat is revisited.
