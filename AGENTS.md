...
- Strict starter scope is `valence_math`, `valence_lang`, `valence_ident`, `valence_text`, and `valence_weather`; broaden beyond these only after a dedicated cleanup pass.
