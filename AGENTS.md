...
- Strict starter scope is `valence_math`, `valence_lang`, `valence_ident`, `valence_text`, `valence_weather`, `valence_world_border`, `valence_boss_bar`, `valence_player_list`, `valence_scoreboard`, `valence_equipment`, `valence_advancement`, `valence_anvil`, `valence_inventory`, and `valence_registry`; broaden beyond these only after a dedicated cleanup pass.
