...
- Strict starter scope is `valence_math`, `valence_lang`, `valence_ident`, `valence_text`, `valence_weather`, `valence_world_border`, and `valence_boss_bar`; broaden beyond these only after a dedicated cleanup pass.
