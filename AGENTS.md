...
- Strict starter scope is `valence_math`, `valence_lang`, `valence_ident`, `valence_text`, `valence_weather`, `valence_world_border`, `valence_boss_bar`, `valence_player_list`, and `valence_scoreboard`; broaden beyond these only after a dedicated cleanup pass.
