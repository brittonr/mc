use super::*;
use crate::id_map::{
    VanillaIDMap, FLATTENING_PROTOCOL_VERSION, LEGACY_BLOCK_DATA_VALUE_COUNT, LEGACY_BLOCK_ID_SHIFT,
};
...
macro_rules! define_blocks {
    (
        ...
        mod block_registration_functions {
            ...
            $(
                ...
                pub fn $name(
                    ...
                    blocks_modded: &mut HashMap<String, [Option<Block>; LEGACY_BLOCK_DATA_VALUE_COUNT]>,
                    flat_id: &mut usize,
                    ...
                    for block in iter {
                        ...
                        if let Some(modid) = block.get_modid() {
                            ...
                            if !(*blocks_modded).contains_key(modid) {
                                (*blocks_modded).insert(modid.to_string(), [None; LEGACY_BLOCK_DATA_VALUE_COUNT]);
                            }
        ...
        pub fn gen_id_map(protocol_version: i32) -> VanillaIDMap {
            ...
            let mut blocks_modded: HashMap<String, [Option<Block>; LEGACY_BLOCK_DATA_VALUE_COUNT]> = HashMap::new();
            let mut flat_id = 0;
            ...
            VanillaIDMap::from_parts(protocol_version, blocks_flat, blocks_hier, blocks_modded)
        }
    );
}
...
pub const GENERATED_BLOCK_DATA_OWNER: &str = "clients/stevenarella/blocks/src/runtime/generated.rs";
const PROTOCOL_1_12_2: i32 = 340;
const PROTOCOL_1_14: i32 = 477;
const PROTOCOL_1_16: i32 = 735;
const STRUCTURE_BLOCK_BASE_ID: usize = 255;
const STRUCTURE_BLOCK_DATA_MODE_DATA: usize = 3;
const STRUCTURE_BLOCK_SAVE_HIERARCHICAL_ID: usize =
    STRUCTURE_BLOCK_BASE_ID << LEGACY_BLOCK_ID_SHIFT;
const STRUCTURE_BLOCK_DATA_HIERARCHICAL_ID: usize =
    STRUCTURE_BLOCK_SAVE_HIERARCHICAL_ID | STRUCTURE_BLOCK_DATA_MODE_DATA;
const STRUCTURE_BLOCK_SAVE_FLAT_ID_1_13_2: usize = 8595;
const STRUCTURE_BLOCK_DATA_FLAT_ID_1_13_2: usize = 8598;
const CONDUIT_WATERLOGGED_FLAT_ID_1_14: usize = 9113;
const NOTE_BLOCK_PLING_LAST_NOTE_FLAT_ID_1_16: usize = 1048;
const NOTE_BLOCK_LAST_NOTE: u8 = 24;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct GeneratedDataSample {
    pub protocol_version: i32,
    pub vanilla_id: usize,
    pub expected: Block,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct GeneratedDataFreshnessError {
...
pub const GENERATED_DATA_SAMPLES: &[GeneratedDataSample] = &[
    GeneratedDataSample {
        protocol_version: PROTOCOL_1_12_2,
        vanilla_id: STRUCTURE_BLOCK_SAVE_HIERARCHICAL_ID,
        expected: Block::StructureBlock {
            mode: StructureBlockMode::Save,
        },
    },
    GeneratedDataSample {
        protocol_version: PROTOCOL_1_12_2,
        vanilla_id: STRUCTURE_BLOCK_DATA_HIERARCHICAL_ID,
        expected: Block::StructureBlock {
            mode: StructureBlockMode::Data,
        },
    },
    GeneratedDataSample {
        protocol_version: FLATTENING_PROTOCOL_VERSION,
    ...
    GeneratedDataSample {
        protocol_version: FLATTENING_PROTOCOL_VERSION,
        vanilla_id: STRUCTURE_BLOCK_DATA_FLAT_ID_1_13_2,
        expected: Block::StructureBlock {
            mode: StructureBlockMode::Data,
        },
    },
    GeneratedDataSample {
        protocol_version: PROTOCOL_1_14,
        vanilla_id: CONDUIT_WATERLOGGED_FLAT_ID_1_14,
        expected: Block::Conduit { waterlogged: true },
    },
    GeneratedDataSample {
        protocol_version: PROTOCOL_1_16,
        vanilla_id: NOTE_BLOCK_PLING_LAST_NOTE_FLAT_ID_1_16,
        expected: Block::NoteBlock {
...
pub fn check_generated_data_freshness() -> Result<(), GeneratedDataFreshnessError> {
    validate_generated_data_samples(GENERATED_DATA_SAMPLES)
}

pub fn validate_generated_data_samples(
    samples: &[GeneratedDataSample],
) -> Result<(), GeneratedDataFreshnessError> {
    let modded_block_ids = HashMap::new();

    for sample in samples {
        let id_map = VanillaIDMap::new(sample.protocol_version);
        let actual = id_map.by_vanilla_id(sample.vanilla_id, &modded_block_ids);
        if actual != sample.expected {
            return Err(GeneratedDataFreshnessError {
                owner: GENERATED_BLOCK_DATA_OWNER,
                protocol_version: sample.protocol_version,
                vanilla_id: sample.vanilla_id,
