        ...
        let
          ...
          mc-compat-valence-ctf-invalid-opponent-base-return-drop = pkgs.writeShellApplication {
            ...
            text = ''
              ...
              exec mc-compat-runner "$mode"                 --server-backend valence                 --scenario ctf-invalid-opponent-base-return-drop                 --receipt "$receipt"                 "$@"
            '';
            meta = {
          ...
          mc-compat-valence-survival-furnace-smelting-breadth = pkgs.writeShellApplication {
            ...
            text = ''
              ...
              exec mc-compat-runner "$mode"                 --server-backend valence                 --scenario survival-furnace-smelting-breadth                 --receipt "$receipt"                 "$@"
            '';
            meta = {
