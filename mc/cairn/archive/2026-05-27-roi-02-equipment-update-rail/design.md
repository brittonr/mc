# Design: Equipment update observation rail

## Approach

Create a smaller prerequisite proof for equipment packet semantics if armor mitigation is too broad to drain first.
