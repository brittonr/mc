# Design: Scenario triage receipt blocks

## Approach

Improve operator debugging across maintained rails by making failures self-triaging rather than log spelunking exercises.
