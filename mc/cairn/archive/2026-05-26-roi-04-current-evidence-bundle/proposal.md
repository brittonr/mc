# Proposal: Current protocol-763 evidence bundle index

## Summary

Drain ROI-ranked maintenance slice `roi-04-current-evidence-bundle` for the Minecraft compatibility evidence workspace.
