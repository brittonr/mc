...
- [x] [serial] Add positive travel/collision scenarios. r[mc_compatibility.prove_projectile_travel_collision.positive_projectile_scenarios]
...
- Positive validation promotes two protocol-763 live receipt-backed rows: projectile use/loadout and pinned projectile damage attribution.
