# Proposal: Maintained dry-run aggregate catalog

## Summary

Drain ROI-ranked maintenance slice `roi-05-dry-run-aggregate` for the Minecraft compatibility evidence workspace.
