...
- [x] [serial] Satisfy `receipt_nonclaims`. r[mc_compatibility.roi_03_projectile_hit_rail.receipt_nonclaims]
  ...
  - Reviewable live receipt copy: `docs/evidence/protocol-763-roi-03-projectile-hit-2026-05-27.receipt.json`.
  - Reviewable dry-run receipt copy: `docs/evidence/protocol-763-roi-03-projectile-hit-2026-05-27.dry-run.receipt.json`.
