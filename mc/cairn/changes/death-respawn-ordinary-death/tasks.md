...
- [ ] [depends:contract] Add deterministic checker positive and negative fixtures for `ordinary death/respawn`. r[mc_compatibility.death_respawn_ordinary_death.checker]
- [ ] [depends:checker] Enforce row-specific evidence standard before promotion. r[mc_compatibility.death_respawn_ordinary_death.evidence_standard]
