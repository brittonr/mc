...
- [ ] [depends:contract] Add deterministic checker positive and negative fixtures for `creative-mode inventory`. r[mc_compatibility.inventory_creative_mode.checker]
