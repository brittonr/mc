...
- [ ] [depends:readiness] Mark `survival-crafting-table` typed-event-ready in the manifest and regenerate scenario surfaces without changing wrapper, dry-run, row, or non-claim scope. r[mc_compatibility.survival_crafting_table_typed_event_migration.readiness]
  Evidence: TBD
- [ ] [depends:readiness] Add `survival-crafting-table` to the typed-event pass/fail gate with positive and negative fixtures for missing events and misordered crafting phases. r[mc_compatibility.survival_crafting_table_typed_event_migration.gate]
  Evidence: TBD
- [ ] [depends:gate] Run focused post-change validation for runner fixtures, scenario-manifest checks, generated surfaces, survival crafting-table dry-run receipt shape, and evidence manifests. r[mc_compatibility.survival_crafting_table_typed_event_migration.validation]
  Evidence: TBD
