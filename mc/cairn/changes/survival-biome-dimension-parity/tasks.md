...
- [x] [depends:contract] Add deterministic checker positive and negative fixtures for paired evidence, missing metrics, mismatches, stale revisions, and Valence-only evidence. r[mc_compatibility.survival_biome_dimension.checker] Evidence: `docs/evidence/survival-row-parity-checker-2026-06-01.run.log`, `docs/evidence/survival-row-parity-checker-2026-06-01.b3`.
- [x] [depends:checker] Add the `survival-biome-dimension-state` runner/client rail without broadening existing scenarios. r[mc_compatibility.survival_biome_dimension.runner] Evidence: `docs/evidence/survival-biome-dimension-runner-2026-06-01.run.log`, `docs/evidence/survival-biome-dimension-runner-2026-06-01.b3`.
