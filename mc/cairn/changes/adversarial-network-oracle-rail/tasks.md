...
- [ ] [depends:contract] Add deterministic checker positive and negative fixtures for `adversarial-network safety`. r[mc_compatibility.adversarial_network_oracle_rail.checker]
