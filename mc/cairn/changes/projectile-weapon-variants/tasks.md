...
- [ ] [depends:contract] Add deterministic checker positive and negative fixtures for `projectile weapon variants`. r[mc_compatibility.projectile_weapon_variants.checker]
