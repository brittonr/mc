...
- [ ] [depends:contract] Add deterministic checker positive and negative fixtures for `production readiness aggregate`. r[mc_compatibility.production_readiness_envelope.checker]
