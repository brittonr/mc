...
- [x] [depends:checker] Enforce row-specific evidence standard before promotion. r[mc_compatibility.production_readiness_envelope.evidence_standard] Evidence: `docs/evidence/aggregate-claim-gates-2026-06-01.run.log`, `docs/evidence/aggregate-claim-gates-2026-06-01.b3`.
- [x] [depends:evidence_standard] Add `production-readiness-envelope` rail/checker wiring without broadening existing scenarios. r[mc_compatibility.production_readiness_envelope.rail] Evidence: `docs/evidence/aggregate-claim-gates-2026-06-01.run.log`, `docs/evidence/aggregate-claim-gates-2026-06-01.b3`.
...
- [x] [depends:rail] Copy reviewable row artifacts under `docs/evidence/`, including receipts/logs/check output, BLAKE3 manifests, and oracle checkpoints where required. r[mc_compatibility.production_readiness_envelope.artifacts] Evidence: `docs/evidence/aggregate-claim-gates-2026-06-01.run.log`, `docs/evidence/aggregate-claim-gates-2026-06-01.b3`.
