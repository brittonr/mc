...
- [ ] [depends:contract] Add deterministic checker positive and negative fixtures for `spawn/team balance/resource reset`. r[mc_compatibility.ctf_spawn_team_balance_reset.checker]
