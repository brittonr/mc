...
- `valence_protocol` has a crate-level Octet compatibility allow because it mirrors Minecraft packet names and wire-format APIs with underscore packet modules, generated packet structs, and protocol arithmetic.
