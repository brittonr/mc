...
| ROI 02 equipment update rail | `docs/evidence/protocol-763-roi-02-equipment-update-observation-2026-05-27.receipt.json`; `docs/evidence/protocol-763-roi-02-equipment-update-observation-2026-05-27.run.log`; `docs/evidence/protocol-763-roi-02-equipment-update-observation-2026-05-27.dry-run.receipt.json` | live `8100dde3ebb3476984235009e277d7e973037b7873b2fdb30c413093e1498d3d`; run log `184223509605c1dc9b89db3d8c77ff0b8b7a1c103bec8031de75515d4777dc16`; dry-run `a8b83683a03e2601b7a18e2fe3f5ac02ca535f866afe8bac9cce801967b74810`; dry-run Nix gate rerun in pueue task `24`; live rerun passed in pueue task `25` | Reviewable from copied receipt/log plus gate. |
...
- Inspected evidence: tracked receipt copies above, BLAKE3 manifests, archived tasks, current bundle, Cairn validation, pueue task `14` dry-run gate success, pueue task `24` post-fix runner/gate success, and pueue task `25` ROI 02 live rerun success.
