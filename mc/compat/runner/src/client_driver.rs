use crate::backend_shell::{force_stop_server, probe_status, start_server, stop_server};
use crate::evidence_core::{
    evaluate_projectile_damage_causality_for_damage, evaluate_projectile_travel_collision,
    evaluate_scenario_for_config, evaluate_server_scenario,
    validate_typed_event_oracle_for_migrated_scenario,
};
use crate::evidence_receipts::{evaluate_frame_artifacts_receipt, mcp_control_tool_list_digest};
use crate::evidence_types::{
    ClientLogSlice, FrameArtifactReceiptItem, FrameArtifactsReceiptEvidence, McpControlRunEvidence,
...
use crate::json_support::{
    json_bool_field, json_string, json_string_field, json_u32_field, json_u64_field,
};
use crate::runner_config::{ClientRunEvidence, Config, ManagedServer, Mode, ServerBackend};
use crate::scenario_catalog::{
    SURVIVAL_BLOCK_ENTITY_SERVER_CLEAN_NEEDLE, SURVIVAL_BLOCK_ENTITY_SERVER_RESTART_NEEDLE,
    ...
    SURVIVAL_WORLD_MULTICHUNK_SERVER_CLEAN_NEEDLE, SURVIVAL_WORLD_MULTICHUNK_SERVER_RESTART_NEEDLE,
...
use crate::scenario_core::{
    scenario_name, Scenario, ScenarioRunStrategy, FIRST_CLIENT_INDEX,
    RECONNECT_SESSION_COUNT_NEEDLE, SESSION_INDEX_ENV_OFFSET,
};
use crate::{
    append_count_marker, apply_build_env, apply_env_patch_to_command, apply_headless_env,
    backend_name, env_path, log, projectile_damage_amount_needle,
    projectile_damage_client_health_needle, projectile_damage_server_health_after_needle,
    scenario_behavior, temp_client_log_for, ScenarioBehavior, FRAME_ARTIFACT_NON_CLAIMS,
    MCP_CONTROLLED_SMOKE_SCENARIO, MCP_CONTROL_CAPTURE_ID, MCP_CONTROL_CHAT_ID,
    MCP_CONTROL_CONNECTED_TOKEN, MCP_CONTROL_FAILURE_COMMAND, MCP_CONTROL_FAILURE_FRAME_CAPTURE,
    MCP_CONTROL_FAILURE_HANDSHAKE, MCP_CONTROL_FAILURE_STATUS_TIMEOUT,
    MCP_CONTROL_FAILURE_TOOLS_LIST, MCP_CONTROL_INITIALIZE_ID, MCP_CONTROL_JSONRPC_VERSION_NEEDLE,
    MCP_CONTROL_KEY_ID, MCP_CONTROL_KILL_SIGNAL, MCP_CONTROL_LIVE_CAPTURE_DIR_SUFFIX,
    MCP_CONTROL_LIVE_CAPTURE_RELATIVE_PATH, MCP_CONTROL_LIVE_STDERR_LOG_EXTENSION,
    MCP_CONTROL_LIVE_TRANSCRIPT_EXTENSION, MCP_CONTROL_LOOK_ID, MCP_CONTROL_MAX_STATUS_POLLS,
    MCP_CONTROL_OUTCOME_APPLIED_ESCAPED, MCP_CONTROL_PROCESS_GROUP_COMMAND,
    MCP_CONTROL_REQUIRED_CALLS, MCP_CONTROL_REQUIRED_OUTCOME_IDS, MCP_CONTROL_RESULT_NEEDLE,
    MCP_CONTROL_STATUS_ID_PREFIX, MCP_CONTROL_STATUS_POLL_MILLIS, MCP_CONTROL_TERMINATE_COMMAND,
    MCP_CONTROL_TERMINATE_GRACE_MILLIS, MCP_CONTROL_TERMINATE_SIGNAL,
    MCP_CONTROL_TOOLS_ARRAY_NEEDLE, MCP_CONTROL_TOOLS_LIST_ID, MCP_CONTROL_TOOL_NAMES,
    MULTI_CLIENT_LOAD_PEER_TIMEOUT_SECS, MULTI_CLIENT_START_STAGGER_SECS,
    PROJECTILE_DAMAGE_AMOUNT_NEEDLE, PROJECTILE_DAMAGE_ATTACKER_SUFFIX,
    ...
    PROJECTILE_DAMAGE_SERVER_USE_NEEDLE, PROJECTILE_DAMAGE_VICTIM_START_HEALTH,
    PROJECTILE_DAMAGE_VICTIM_SUFFIX, PROJECTILE_TRAVEL_COLLISION_CLIENT_SPAWN_NEEDLE,
    PROJECTILE_TRAVEL_COLLISION_CLIENT_TRAVEL_NEEDLE, PROJECTILE_TRAVEL_COLLISION_COLLISION_KIND,
    PROJECTILE_TRAVEL_COLLISION_LOADOUT_ARROW_COUNT, PROJECTILE_TRAVEL_COLLISION_POLICY_GENERATION,
    PROJECTILE_TRAVEL_COLLISION_POLICY_ID, PROJECTILE_TRAVEL_COLLISION_PROJECTILE_ID,
    PROJECTILE_TRAVEL_COLLISION_PROOF_BASIS, PROJECTILE_TRAVEL_COLLISION_SAMPLE_INDEX,
    PROJECTILE_TRAVEL_COLLISION_SAMPLE_KIND, PROJECTILE_TRAVEL_COLLISION_SERVER_COLLISION_NEEDLE,
    PROJECTILE_TRAVEL_COLLISION_SERVER_TRAVEL_NEEDLE,
    PROJECTILE_TRAVEL_COLLISION_VICTIM_END_HEALTH, PROJECTILE_TRAVEL_COLLISION_WEAPON,
    RECONNECT_SEQUENCE_PAUSE_SECS, RECONNECT_SEQUENCE_SESSION_COUNT, SAFETY_SINGLE_SESSION_COUNT,
    SURVIVAL_WORLD_PERSISTENCE_INITIAL_PHASE, SURVIVAL_WORLD_PERSISTENCE_POST_RESTART_PHASE,
    XVFB_SERVER_ARGS,
};
...
pub(crate) const PLAN_CLIENT_LOG_ENV_OR_TEMP: &str = "CLIENT_LOG-or-temp-mc-compat-client-log";
pub(crate) const PLAN_CLIENT_LOG_TEMP: &str = "temp-mc-compat-client-log";
pub(crate) const PLAN_CLIENT_LOG_RECONNECT_TEMP: &str = "temp-mc-compat-reconnect-session-log";
