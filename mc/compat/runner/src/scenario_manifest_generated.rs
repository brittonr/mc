...
pub(crate) const SCENARIO_MANIFEST_ROWS: &[GeneratedScenarioRow] = &[
    ...
    GeneratedScenarioRow {
        name: "ctf-invalid-opponent-base-return-drop",
        ...
        client_count: ONE_CLIENT,
        session_count: ONE_SESSION,
        dry_run_check: "mc-compat-valence-ctf-invalid-opponent-base-return-drop-dry-run",
        dry_run_wrapper: "mc-compat-valence-ctf-invalid-opponent-base-return-drop",
        dry_run_exclusion_reason: "",
        migration_state: "typed-event-ready",
    },
    GeneratedScenarioRow {
