...
use checker_framework::{
    ...
    require_exact_fields, require_ok_fields, require_true_fields, run_checker, Checker,
    ExpectedField, KeyValueRecord, ValidationResult,
};
...
struct ScoreboardTeamPacketFamilyChecker;

impl Checker for ScoreboardTeamPacketFamilyChecker {
...
fn validate_evidence(evidence: &KeyValueRecord) -> ValidationResult {
...
fn main() {
    run_checker(&ScoreboardTeamPacketFamilyChecker);
}
