use crate::{
    ...
    SURVIVAL_CRAFTING_BREADTH_SERVER_CLEAR_NEEDLE, SURVIVAL_CRAFTING_BREADTH_SERVER_INVALID_NEEDLE,
    SURVIVAL_CRAFTING_BREADTH_SERVER_SHAPED_NEEDLE,
    SURVIVAL_CRAFTING_BREADTH_SERVER_SHAPELESS_NEEDLE,
    SURVIVAL_CRAFTING_BREADTH_SERVER_STATE_NEEDLE, SURVIVAL_CRAFTING_CLIENT_COLLECT_NEEDLE,
    SURVIVAL_CRAFTING_CLIENT_INPUT_A_NEEDLE, SURVIVAL_CRAFTING_CLIENT_INPUT_B_NEEDLE,
    SURVIVAL_CRAFTING_CLIENT_INVENTORY_NEEDLE, SURVIVAL_CRAFTING_CLIENT_OPEN_NEEDLE,
    SURVIVAL_CRAFTING_CLIENT_RESULT_NEEDLE, SURVIVAL_CRAFTING_SERVER_COLLECT_NEEDLE,
    SURVIVAL_CRAFTING_SERVER_INPUT_A_NEEDLE, SURVIVAL_CRAFTING_SERVER_INPUT_B_NEEDLE,
    SURVIVAL_CRAFTING_SERVER_OPEN_NEEDLE, SURVIVAL_CRAFTING_SERVER_RESULT_NEEDLE,
    ...
    SURVIVAL_FURNACE_CLIENT_INVALID_FUEL_NEEDLE, SURVIVAL_FURNACE_CLIENT_INVENTORY_NEEDLE,
    SURVIVAL_FURNACE_CLIENT_OPEN_NEEDLE, SURVIVAL_FURNACE_CLIENT_OUTPUT_NEEDLE,
    SURVIVAL_FURNACE_CLIENT_RECONNECT_NEEDLE, SURVIVAL_FURNACE_CLIENT_REOPEN_NEEDLE,
    SURVIVAL_FURNACE_SERVER_BREADTH_STATE_NEEDLE, SURVIVAL_FURNACE_SERVER_BURN_NEEDLE,
    SURVIVAL_FURNACE_SERVER_COLLECT_NEEDLE, SURVIVAL_FURNACE_SERVER_FUEL_NEEDLE,
    SURVIVAL_FURNACE_SERVER_INPUT_NEEDLE, SURVIVAL_FURNACE_SERVER_INVALID_FUEL_NEEDLE,
    SURVIVAL_FURNACE_SERVER_OPEN_NEEDLE, SURVIVAL_FURNACE_SERVER_OUTPUT_NEEDLE,
    SURVIVAL_FURNACE_SERVER_REOPEN_NEEDLE, SURVIVAL_FURNACE_SERVER_STATE_NEEDLE,
    SURVIVAL_HUNGER_FOOD_CLIENT_INVENTORY_NEEDLE, SURVIVAL_HUNGER_FOOD_CLIENT_ITEM_NEEDLE,
    SURVIVAL_HUNGER_FOOD_CLIENT_POST_NEEDLE, SURVIVAL_HUNGER_FOOD_CLIENT_PRE_NEEDLE,
    SURVIVAL_HUNGER_FOOD_CLIENT_USE_NEEDLE, SURVIVAL_HUNGER_FOOD_SERVER_CONSUME_FINISH_NEEDLE,
    ...
    SURVIVAL_HUNGER_HEALTH_CLIENT_INVENTORY_NEEDLE, SURVIVAL_HUNGER_HEALTH_CLIENT_ITEM_NEEDLE,
    SURVIVAL_HUNGER_HEALTH_CLIENT_POST_NEEDLE, SURVIVAL_HUNGER_HEALTH_CLIENT_PRE_NEEDLE,
