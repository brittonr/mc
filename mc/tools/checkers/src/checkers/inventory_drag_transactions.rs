use crate::key_value::{
    ...
    require_clean_child_revision, require_exact, require_ok, KeyValueChecker, KeyValueEvidence,
    KeyValueRecord, ValidationResult, TRUE_VALUE,
};
...
pub struct DragTransactionsChecker;
...
impl KeyValueChecker for DragTransactionsChecker {
...
mod tests {
    ...
    const EXPECTED_OVERCLAIM_DIAGNOSTIC: &str =
        "broad overclaim claim.full_inventory_semantics=true";
