#!/usr/bin/env -S CARGO_TARGET_DIR=target/check-crafting-recipe-valence-shell-contract-script nix shell "github:nix-community/fenix?rev=092bd452904e749efa39907aa4a20a42678ac31e#minimal.toolchain" nixpkgs#gcc -c cargo -q -Zscript
...
const DEFAULT_CONTRACT_PATH: &str = "docs/crafting-recipe-valence-shell-contract.md";
const SUCCESS_MESSAGE: &str = "crafting recipe Valence shell contract check passed";
const SELF_TEST_SUCCESS_MESSAGE: &str = "crafting recipe Valence shell contract self-test passed";
const HELP_TEXT: &str = "usage: check_crafting_recipe_valence_shell_contract.rs [--self-test] [--root PATH] [--contract PATH]";
...
const REQUIRED_GROUPS: &[RequiredGroup] = &[
    RequiredGroup {
        ...
        phrases: &[
            "## Target scope",
            "selected-matrix Valence shell contract",
    ...
    RequiredGroup {
        ...
        phrases: &[
            ...
            "docs/crafting-recipe-selected-matrix-data-fixture.md",
            "docs/crafting-recipe-selected-matrix-receipt-handoff.md",
    ...
    RequiredGroup {
        ...
        phrases: &[
            ...
            "call the selected-matrix core",
            "apply only the returned recipe match",
    ...
    RequiredGroup {
        ...
        phrases: &[
            ...
            "CraftingGridResource",
            "CraftingRecipeTableResource",
            "CraftingOutputSlotComponent",
            "CraftingCollectionEvent",
            "CraftingDiagnosticEvent",
        ],
    },
    RequiredGroup {
    ...
    RequiredGroup {
        ...
        phrases: &[
            ...
            "When CraftingTableShellPlugin is not installed",
            "no crafting resources are inserted",
            "no crafting events are registered",
            "no crafting systems run",
            "no crafting packets or milestones are emitted",
    ...
    RequiredGroup {
        ...
        phrases: &[
            ...
            "all-recipe/collection-mode overclaims",
        ],
    },
    RequiredGroup {
    ...
    RequiredGroup {
        ...
        phrases: &[
            ...
            "No arbitrary collection-mode breadth",
            "No shift-click",
...
const REJECTED_PHRASES: &[RejectedPhrase] = &[
    RejectedPhrase {
        ...
        lowercase_phrase: "adds craftingtableshellplugin to defaultplugins",
    },
    RejectedPhrase {
        code: "contract_rejected_default_plugins_overclaim",
    ...
    RejectedPhrase {
        code: "contract_rejected_all_collection_overclaim",
        lowercase_phrase: "claims arbitrary collection-mode breadth",
    },
    RejectedPhrase {
        code: "contract_rejected_all_collection_overclaim",
        lowercase_phrase: "claims all collection modes",
    },
    RejectedPhrase {
...
const SELF_TEST_VALID_CONTRACT: &str = r#"# Crafting recipe Valence shell contract
...
const NEGATIVE_REMOVAL_SELF_TESTS: &[NegativeRemovalSelfTest] = &[
    ...
    NegativeRemovalSelfTest {
        ...
        phrase_to_remove: "no crafting systems run",
...
const NEGATIVE_OVERCLAIM_SELF_TESTS: &[NegativeOverclaimSelfTest] = &[
    NegativeOverclaimSelfTest {
        ...
        phrase_to_append: "adds CraftingTableShellPlugin to DefaultPlugins",
    ...
    NegativeOverclaimSelfTest {
        name: "all collection overclaim",
        phrase_to_append: "claims arbitrary collection-mode breadth",
        expected_code: "contract_rejected_all_collection_overclaim",
    },
    NegativeOverclaimSelfTest {
