  ...
  flake-utils.lib.eachSystem
    ...
    rec
    {
        ...
        checks.octet = octet.lib.mkConsumerCheck {
          ...
          packages = [ "valence_math" "valence_lang" "valence_ident" "valence_text" "valence_weather" "valence_world_border" "valence_boss_bar" "valence_player_list" "valence_scoreboard" "valence_equipment" ];
